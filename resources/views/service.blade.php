			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="active"><a class="nav-link" href="{{ url('/service') }}">Services</a></li>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p><a href="" class="btn btn-secondary me-2">Shop Now</a><a href="{{ url('/about') }}" class="btn btn-white-outline">Explore</a></p>
							</div>
						</div>
						<div class="col-lg-7">
